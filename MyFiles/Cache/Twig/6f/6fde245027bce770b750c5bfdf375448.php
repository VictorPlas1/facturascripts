...
class __TwigTemplate_3050904f1ad6ef752aea8adf3493de7c extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 41
            yield "        ";
            yield from             $this->loadTemplate((($__internal_compile_0 = $context["item"]) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["path"] ?? null) : null), "Master/MenuBgTemplate.html.twig", 41)->unwrap()->yield($context);
            // line 42
            yield "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 44
            yield "        ";
            yield from             $this->loadTemplate((($__internal_compile_1 = $context["item"]) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["path"] ?? null) : null), "Master/MenuBgTemplate.html.twig", 44)->unwrap()->yield($context);
            // line 45
            yield "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return new Source("", "Master/MenuBgTemplate.html.twig", "C:\\wamp64\\www\\facturascripts\\Dinamic\\View\\Master\\MenuBgTemplate.html.twig");
    }
}
